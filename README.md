...
<p>
Using forecasts tailored by country above, we can make a comparison between countries on how the number of cases are forecasted to change over the next one month as shown in the two charts below.
<p>
