...
<img src="https://github.com/khairulomar/Covid-19/blob/master/img/ydl-logo-small.png?raw=true" align="left>In partnership with Young Digital Leaders (YDL), a group of data volunteers set up by officials from the Ministry of Health of Malaysia, I authored the following analysis to support decision-makers in tackling Covid-19 outbreak in the country:
<p>
